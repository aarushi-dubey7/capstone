              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="123456"
                    className="w-full border border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 rounded-xl pl-4 pr-12 py-3 focus:outline-none focus:ring-2 focus:ring-brand-500"
                  />
                  <button
                    type="button"
